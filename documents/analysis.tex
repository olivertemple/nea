...
The website should be able to run algorithms written by the user for both maze generation and solving. 
\paragraph{Steps}
\begin{itemize}
...
\lstinputlisting[language=python, linewidth=\linewidth]{../python api/lambda_function.py}

\subsubsection{Python API: grid.py}
\lstinputlisting[language=python, linewidth=\linewidth]{../python api/grid.py}

\subsubsection{Python API: generator.py}
\lstinputlisting[language=python, linewidth=\linewidth]{../python api/generator.py}

\subsubsection{Python API: solver.py}
\lstinputlisting[language=python, linewidth=\linewidth]{../python api/solver.py}

\subsubsection{React App: App.js}
\lstinputlisting[language=JavaScript, linewidth=\linewidth]{../react app/src/App.js}

\subsubsection{React App: Menu.jsx}
\lstinputlisting[language=JavaScript, linewidth=\linewidth]{../react app/src/components/Menu.jsx}

\subsubsection{React App: MenuKey.jsx}
\lstinputlisting[language=JavaScript, linewidth=\linewidth]{../react app/src/components/MenuKey.jsx}

\subsubsection{React App: DisplayGrid.jsx}
\lstinputlisting[language=JavaScript, linewidth=\linewidth]{../react app/src/components/DisplayGrid.jsx}

\subsubsection{React App: DisplayNode.jsx}
\lstinputlisting[language=JavaScript, linewidth=\linewidth]{../react app/src/components/DisplayNode.jsx}
...
\end{quote}
Having contemplated this user feedback, I have decided that the speed slider should be changed. To do this, I have altered the code so that a lower value of the slider will result in a faster visualization. This change has been reflected in the live version of the project.
\paragraph*{Before}
previously the value of the slider was used as the value of the speed. When the value of the slider was lower, the value of the animation was slower and hance the visualization was faster.
\lstinputlisting[language=JavaScript, linewidth=1\linewidth]{./previous.jsx}
\paragraph*{After}
...
\lstinputlisting[language=JavaScript, linewidth=1\linewidth]{./current.jsx}
